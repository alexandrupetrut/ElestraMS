    ...
    var appElestra = angular.module('appElestra', ['ngRoute', 'ngCookies', 'angularUtils.directives.dirPagination', 'angular-loading-bar']);

appElestra.run(function ($rootScope, $cookies, $http) {
...
appElestra.config(function ($routeProvider, $httpProvider) {
...
appElestra.directive('fileModel', function ($parse) {
    return {
        restrict: 'A',
...
appElestra.factory("utilityService", function ($http) {
    utilityObj = {};
...
appElestra.controller('appElestraController', function ($scope, $rootScope, $location, $cookies, utilityService) {
