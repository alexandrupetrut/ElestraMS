appElestra.factory('recoverPasswordService', function ($http,$rootScope) {
    recoverPasswordObj = {};
...
appElestra.controller('recoverPasswordController', function ($scope, recoverPasswordService, utilityService) {
