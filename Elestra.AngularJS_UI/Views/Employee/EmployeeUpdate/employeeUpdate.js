appElestra.factory('employeeUpdateService', function ($http,$rootScope) {
...
appElestra.controller('employeeUpdateController', function ($scope,$rootScope, $routeParams, employeeUpdateService, utilityService) {
