appElestra.factory('employeeMgmtService', function ($http,$rootScope) {
    empMgmtObj = {};
...
appElestra.controller('employeeMgmtController', function ($scope, employeeMgmtService, utilityService, $window) {
